...
// InsuranceChaincode
type SupplychainCrudChaincode struct {}
...
func main() {
	err := shim.Start(new(SupplychainCrudChaincode))
	if err != nil {
		fmt.Printf("Error starting Insurance CRUD chaincode: %s", err)
	}
}

func (t *SupplychainCrudChaincode) Init(stub shim.ChaincodeStubInterface, function string, args []string) ([]byte, error) {
...
func (t *SupplychainCrudChaincode) Invoke(stub shim.ChaincodeStubInterface, function string, args []string) ([]byte, error) {
...
func (t *SupplychainCrudChaincode) Query(stub shim.ChaincodeStubInterface, function string, args []string) ([]byte, error) {
...
//		args - txId, key, value
//=================================================================================================================================
func (t *SupplychainCrudChaincode) save(stub shim.ChaincodeStubInterface, args []string) ([]byte, error){
...
//		args - txId, key
//=================================================================================================================================
func (t *SupplychainCrudChaincode) retrieve(stub shim.ChaincodeStubInterface, args []string) ([]byte, error){
...
//=================================================================================================================================
func (t *SupplychainCrudChaincode) isTxIdValid(stub shim.ChaincodeStubInterface, args []string) (bool){
...
//Wipes all data
func (t *SupplychainCrudChaincode) wipeData(stub shim.ChaincodeStubInterface){
...
func (t *SupplychainCrudChaincode) addKey(stub shim.ChaincodeStubInterface, key string) (error) {
...
func (t *SupplychainCrudChaincode) getKeyHolder(stub shim.ChaincodeStubInterface) (KeyHolder, error) {
	bytes, _ := stub.GetState(KEYHOLDER_KEY)
